...
The plot below illustrates the class imbalance in the original dataset.

![Sum of number of records for each level](images/LevelsOfDR.png){width="343"}

The dataset consist of 35,126 set of images. The classes have an uneven distribution of images.
